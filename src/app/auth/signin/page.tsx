  ...
  return (
    <main>
      <Spin tip="Loading..." spinning={loading}>
        <div className="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10 h-[100vh] flex items-center justify-center">
          <div className="rounded-xl border border-stroke shadow-default dark:border-strokedark bg-boxdark text-white/70">
                  ...
                  <form onSubmit={handleSubmit}>
                    <div className="mb-4">
                      ...
                      <div className="relative">
                        <input
                          type="email"
                          value={userInfo.email} onChange={({ target }) => setUserInfo({ ...userInfo, email: target.value })}
                    ...
                    <div className="mb-6">
                      ...
                      <div className="relative">
                        <input
                          type="password"
                          value={userInfo.password} onChange={({ target }) => setUserInfo({ ...userInfo, password: target.value })}
